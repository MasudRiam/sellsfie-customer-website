    ...
    return (
        ...
        <div className="p-4 space-y-4">
            <SheetHeader className="p-0 ">
                <SheetTitle className="text-xl">✏️ Add note for seller</SheetTitle>
            </SheetHeader>
            <textarea
            placeholder="Write your note..."
            className="w-full h-28 resize-none rounded-md border p-3 text-sm focus:outline-none focus:ring-2 focus:ring-green-500"
            />
